...
python ../src/isolens/main.py -b example.txmap.bam -p example.lz4 -m example.isolens.mod.tsv.gz -a example.isolens.pa.tsv.gz --out-per-base example.isolens.modpb.tsv.gz -z
```
